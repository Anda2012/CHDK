...
* **Official SVN Repository:** [[https://subversion.assembla.com/svn/chdk/branches/release-1_6/](https://subversion.assembla.com/svn/chdk/branches/release-1_6/)
...
```bash
git clone https://github.com/Anda2012/CHDK.git
cd CHDK
```
